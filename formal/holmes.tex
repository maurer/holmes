...
\todo{No aggregation yet. Haven't decided if I want a logic with judgements other than true and false for value-based aggregation, or if I want to do my positional aggregation scheme.}
\end{document}
